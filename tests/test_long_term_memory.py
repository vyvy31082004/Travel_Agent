...
def test_langmem_normalizer_keeps_durable_write_pref_with_search():
        ...
        [
            {
                ...
                "domain": "car",
                "evidence_text": "tôi ưu tiên xe 5 chỗ số tự động",
            },
            {
                "memory_text": "Ưu tiên xe số tự động",
                "category": "car_preference",
                "domain": "car",
                "evidence_text": "số tự động",
            },
        ],
        user_id="user-1",
        thread_id="thread-1",
    ...
    assert [row.memory_text for row in kept] == [
        "Ưu tiên xe 5 chỗ",
...
def test_deterministic_extractor_skips_session_override_search():
    candidates = extract_candidate_memories(
        [
            {
                "type": "human",
                "content": "Lần này tìm xe số sàn ở Đà Nẵng từ 10–12/10.",
            }
        ],
        user_id="user-1",
        thread_id="thread-1",
