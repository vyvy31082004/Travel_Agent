...
hotel_prompts = ChatPromptTemplate.from_messages(
    [
        (
            ...
            "(e.g. thích biển, ghét biển, ưu tiên trung tâm, yên tĩnh), AFTER search_hotels_tool returns, "
            "ONLY print hotels that match those preferences. Use accessibilityLabel / location cues "
            "(Giáp biển, Cách biển, từ trung tâm, …) to decide. Omit non-matching hotels entirely.\n"
...
primary_prompts = ChatPromptTemplate.from_messages(
    [
        (
            ...
            "- Domain assistants filter what they print from tool output; when you synthesize "
            "their Tool Message for the user, do not reintroduce items that conflict with memory.\n"
