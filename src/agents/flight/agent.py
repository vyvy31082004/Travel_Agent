...
from agents.flight.tools import search_flights, search_flight_price, book_flight, provide_passenger_details
...
flight_tools = [search_flights, search_flight_price, book_flight, provide_passenger_details]
