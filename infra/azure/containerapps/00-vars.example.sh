...
export GEOCODING_RAPIDAPI_HOST="maps-data.p.rapidapi.com"
...
export LONG_TERM_MEMORY_VERIFIER="trustmem"
export LONG_TERM_MEMORY_TRANSITION_PATH="llm"
export LONG_TERM_MEMORY_TRANSITION_MODEL="gemini-2.5-flash"
export LONG_TERM_MEMORY_TRANSITION_CONFIDENCE_THRESHOLD="0.85"
export LONG_TERM_MEMORY_TRANSITION_BATCH_SIZE="10"
export LONG_TERM_MEMORY_DOMAIN_CANDIDATE_LIMIT="50"
export LONG_TERM_MEMORY_ACTION_INFERENCE_ENABLED="false"
export LONG_TERM_MEMORY_APPLICABILITY_JUDGE_ENABLED="true"
export LONG_TERM_MEMORY_APPLICABILITY_BATCH_SIZE="10"
export RAPIDAPI_LOCK_FILE="/tmp/viettrip-rapidapi.lock"
