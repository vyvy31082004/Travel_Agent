...
COMMON_ARGS=(
  ...
  --env-vars
    ...
    LONG_TERM_MEMORY_TRUSTMEM_PROMPT_VERSION="${LONG_TERM_MEMORY_TRUSTMEM_PROMPT_VERSION:-trustmem-verifier-v3}"
    LONG_TERM_MEMORY_TRUSTMEM_TIMEOUT_SECONDS="${LONG_TERM_MEMORY_TRUSTMEM_TIMEOUT_SECONDS:-90}"
